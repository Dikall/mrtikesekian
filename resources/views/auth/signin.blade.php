                        ...
                        <div class="col-xl-4 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                <div class="card-header pb-0 text-left bg-transparent text-center">
                                    <h3 class="font-weight-black text-dark display-6">SISTEM MANAJEMEN RISIKO TI</h3>
                                    <p class="mb-0">Selamat Datang</p>
                                    <p class="mb-0">Silahkan Masuk<br></p>
                                    <p class="mb-0">Menggunakan dibawah ini</p>
                            ...
                            <div class="position-absolute w-40 top-0 end-0 h-100 d-md-block d-none">
                                <div class="oblique-image position-absolute fixed-top ms-auto h-100 z-index-0 bg-cover ms-n8"
                                    ...
                                    <div
                                        ...
                                        <h2 class="mt-3 text-dark font-weight-bold">Gunakan Sistem Kami Untuk Memudahkan Perusahaan Anda</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
