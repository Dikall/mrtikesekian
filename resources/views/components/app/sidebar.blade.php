        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-2">
                <div class="d-flex align-items-center nav-link">
                    ...
                    <span class="font-weight-normal text-md ms-2">Risk Management</span>
                </div>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('risk.create') ? 'active' : '' }}"
                    href="{{ route('risk.create') }}">
                    <span class="nav-link-text ms-1">Add New Risk</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('admin.value') ? 'active' : '' }}"
                    href="{{ route('admin.value') }}">
                    <span class="nav-link-text ms-1">Add New Value</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('miti.create') ? 'active' : '' }}"
                    href="{{ route('miti.create') }}">
                    <span class="nav-link-text ms-1">Add New Mitigations</span>
                </a>
            </li>
            <li class="nav-item mt-2">
                <div class="d-flex align-items-center nav-link">
